...
export const Route = createFileRoute("/")({
  ...
  head: ({ loaderData }) => {
    ...
    const offered = loaderData
      ? [...pricingTiers(loaderData.prices), customTier(loaderData.prices)]
      : [];
    return {
      meta: [
        { title: TITLE },
        ...
        <section className="relative min-h-[440px] overflow-hidden pt-[78px]">
          ...
          <div className="relative z-10 mt-[25px]">
            <p className="max-w-[48ch] text-sm leading-relaxed text-neutral-400">
              UsageFleet reports Anthropic's own 5 hour and weekly utilization, then splits it
              across the device groups you define. Sign in with GitHub or Google, add a machine,
              done.
            </p>
            <Link
          ...
          <div className="relative z-10 ml-auto w-full overflow-hidden border-y border-white/10 bg-black/80 lg:w-3/4">
            ...
            <div className="overflow-x-auto">
              <table className="w-full min-w-[560px] font-mono text-[13px]">
                ...
                <tbody className="[&>tr>td]:border-b [&>tr>td]:border-white/10 [&>tr>td]:px-4 [&>tr>td]:py-2.5 [&>tr>td]:text-right [&>tr>td:first-child]:text-left [&>tr:last-child>td]:border-b-0">
