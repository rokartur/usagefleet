...
vo v3-s1 "I run Claude Code on three machines."
vo v3-s2 "Every time the limit moved — no idea which one did it."
vo v3-s3 "So I built the view I wanted."
vo v3-s4 "Anthropic's official number, attributed across my own machines."
vo v3-s5 "Would you run this? Tell me what's missing."

vo v4-s1 "This product exists because of one very specific annoyance."
vo v4-s2 "Day one: collect counts, never conversations."
vo v4-s3 "Day three: the first split that actually answered it."
vo v4-s4 "The hard part? Not building everything else."
vo v4-s5 "One job. Building it in public. usagefleet dot com."

vo v5-s1 "A micro-SaaS doesn't need a huge idea."
vo v5-s2 "It needs a recurring irritation. Like this one."
vo v5-s3 "Collector. Attribution. Dashboard. That's the whole product."
vo v5-s4 "Not another giant AI platform. On purpose."
vo v5-s5 "Focused enough — or too narrow? You tell me."

vo v6-s1 "Your team shares one Claude budget."
vo v6-s2 "Does anyone actually know where it goes?"
vo v6-s3 "See the five-hour and weekly window by group. Live."
vo v6-s4 "Alert at eighty. Guard at one hundred. Offline? It fails open."
vo v6-s5 "Built for teams using Claude Code way too much."
